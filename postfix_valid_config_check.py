#!/usr/bin/env python3
#
# Name:        postfix_valid_config_check.py
# Date:        2021-03-08
...
def exec_postfix_check():
    ...
    process_info = subprocess.run(["script --quiet --return --command '%s check' /dev/null" % args.postfix_path],
    ...
    return {
        ...
        'output_lines': process_info.stdout.splitlines()
    }
